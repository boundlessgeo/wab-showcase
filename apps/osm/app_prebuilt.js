...
var patternFill_10 = new ol.style.Fill({});
                        var patternImg_10 = new Image();
                        patternImg_10.src = './data/styles/patternFill_10.png';
                        patternImg_10.onload = function(){
                          var canvas = document.createElement('canvas');
                          var context = canvas.getContext('2d');
                          var pattern = context.createPattern(patternImg_10, 'repeat');
                          patternFill_10 = new ol.style.Fill({
                                color: pattern
                              });
                          lyr_ocupacao_agueda.changed()
                        };
var patternFill_12 = new ol.style.Fill({});
                        var patternImg_12 = new Image();
                        patternImg_12.src = './data/styles/patternFill_12.png';
                        patternImg_12.onload = function(){
                          var canvas = document.createElement('canvas');
                          var context = canvas.getContext('2d');
                          var pattern = context.createPattern(patternImg_12, 'repeat');
                          patternFill_12 = new ol.style.Fill({
                                color: pattern
                              });
                          lyr_ocupacao_agueda.changed()
                        };
var patternFill_14 = new ol.style.Fill({});
                        var patternImg_14 = new Image();
                        patternImg_14.src = './data/styles/patternFill_14.png';
                        patternImg_14.onload = function(){
                          var canvas = document.createElement('canvas');
                          var context = canvas.getContext('2d');
                          var pattern = context.createPattern(patternImg_14, 'repeat');
                          patternFill_14 = new ol.style.Fill({
                                color: pattern
                              });
                          lyr_ocupacao_agueda.changed()
                        };
var patternFill_16 = new ol.style.Fill({});
                        var patternImg_16 = new Image();
                        patternImg_16.src = './data/styles/patternFill_16.png';
                        patternImg_16.onload = function(){
                          var canvas = document.createElement('canvas');
                          var context = canvas.getContext('2d');
                          var pattern = context.createPattern(patternImg_16, 'repeat');
                          patternFill_16 = new ol.style.Fill({
                                color: pattern
                              });
                          lyr_ocupacao_agueda.changed()
                        };
...
zIndex: 2
                    ...
                    if (ocupacao_aguedarule2_eval_expression(context)) {
                      ruleStyles.push.apply(ruleStyles, [ new ol.style.Style({
                                stroke: new ol.style.Stroke({color: "rgba(175,179,138,0.0)", lineDash: null, width: pixelsFromMm(0)}),
...
zIndex: 2
                    ...
                    if (ocupacao_aguedarule2_eval_expression(context)) {
                      ruleStyles.push.apply(ruleStyles, [ new ol.style.Style({
                                stroke: new ol.style.Stroke({color: "rgba(255, 204, 0, 1)", lineDash: null, width: pixelsFromMm(0)}),
                            fill: new ol.style.Fill({color: "rgba(255, 204, 0, 1)"}),
zIndex: 0
                            })
                            ,new ol.style.Style({
...
zIndex: 0
            ...
            layer: 'lyr_agueda_points'
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/education_university_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/money_currency_exchange_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/food_bar_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/highway=bus_stop_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/tourist_cinema2_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/food_fastfood_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/amenity=parking_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/health_doctors_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/amenity=place_of_worship_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/amenity_police2_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/amenity_post_office_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/food_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/svg_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/amenity=taxi_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/amenity=telephone_selected.png",
            }),
zIndex: 0
                            })
                            ]);
                  ...
                  anchor: [0.5, 0.5],
                  size:[100,100],
                  src: "./data/styles/amenity_toilets_selected.png",
            }),
zIndex: 0
                            })
                            ]);
...
var originalExtent = [-940579.373272, 4949272.994915, -938532.500885, 4950214.251789];
...
function setTextPathStyle_linhasdegua(){
                setTextPathStyle(lyr_linhasdegua, function (feature){
                    var labelContext = {
                          feature: feature,
                          variables: {},
...
function setTextPathStyle_estradas_agueda(){
                setTextPathStyle(lyr_estradas_agueda, function (feature){
                    var labelContext = {
                          feature: feature,
                          variables: {},
                          layer: 'lyr_$(layerName)s'
                      };
                    if (label_estradas_agueda_eval_expression(labelContext) !== null) {
...
var BasicApp = React.createClass({
  ...
  render: function() {
    var toolbarOptions = {title:"Agueda"};
