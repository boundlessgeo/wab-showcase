...
function ocupacao_aguedarule0_eval_expression(context) {
    ...
    return "'farm', 'farmland'".indexOf(getFeatureAttribute(feature, 'landuse') ) > -1 ;
}
...
function ocupacao_aguedarule1_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'landuse')  == 'forest');
}
...
function ocupacao_aguedarule2_eval_expression(context) {
    ...
    return "'grass', 'greenfield', 'meadow'".indexOf(getFeatureAttribute(feature, 'landuse') ) > -1 ;
}
...
function ocupacao_aguedarule3_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'landuse')  == 'orchard');
}
...
function ocupacao_aguedarule4_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'landuse')  == 'vineyard');
}
...
function estradas_aguedarule0_eval_expression(context) {
    ...
    return "'footway', 'path'".indexOf(getFeatureAttribute(feature, 'highway') ) > -1 ;
}
...
function estradas_aguedarule1_eval_expression(context) {
    ...
    return "'secondary', 'tertiary'".indexOf(getFeatureAttribute(feature, 'highway') ) > -1 ;
}
...
function estradas_aguedarule2_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'highway')  == 'pedestrian');
}
...
function estradas_aguedarule3_eval_expression(context) {
    ...
    return "'residential', 'road'".indexOf(getFeatureAttribute(feature, 'highway') ) > -1 ;
}
...
function estradas_aguedarule5_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'highway')  == 'steps');
}
...
function label_estradas_agueda_eval_expression(context) {
    ...
    return fnc_replace([fnc_replace([getFeatureAttribute(feature, 'name') ,'Rua ','R. '], context),'Travessa ','Tr. '], context);
}
...
function agueda_edificiosrule0_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  === null);
}
...
function label_agueda_edificios_eval_expression(context) {
    ...
    var feature = context.feature;
    function _CASE() {
    if (getFeatureAttribute(feature, 'amenity')  !== null) {
          return getFeatureAttribute(feature, 'name') ;
        }
    else {
     return null;
    }
...
function agueda_pointsrule0_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'university');
}
...
function agueda_pointsrule1_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'atm');
}
...
function agueda_pointsrule2_eval_expression(context) {
    ...
    return "'bar', 'pub'".indexOf(getFeatureAttribute(feature, 'amenity') ) > -1 ;
}
...
function agueda_pointsrule3_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'bus_station');
}
...
function agueda_pointsrule4_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'cinema');
}
...
function agueda_pointsrule5_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'fast_food');
}
...
function agueda_pointsrule6_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'parking');
}
...
function agueda_pointsrule7_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'pharmacy');
}
...
function agueda_pointsrule8_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'place_of_worship');
}
...
function agueda_pointsrule9_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'police');
}
...
function agueda_pointsrule10_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'post_office');
}
...
function agueda_pointsrule11_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'restaurant');
}
...
function agueda_pointsrule12_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'school');
}
...
function agueda_pointsrule13_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'taxi');
}
...
function agueda_pointsrule14_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'telephone');
}
...
function agueda_pointsrule15_eval_expression(context) {
    ...
    return (getFeatureAttribute(feature, 'amenity')  == 'toilets');
}